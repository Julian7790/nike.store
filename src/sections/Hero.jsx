  ...
  return (
    ...
    >
     <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28">
       ...
       <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:lead-[82px] font-bold">
         <span className="xl:bg-white xl:whitespace-nowrap relative z-8 pr-10">The New</span>
         <br />
